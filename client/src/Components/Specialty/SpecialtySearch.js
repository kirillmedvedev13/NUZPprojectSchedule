...
function SelectCathedra({ handleChangeFilters }) {
    ...
    return (<Select className="col-12" isClearable options={options} placeholder="Кафедра" onChange={(e) => {
                ...
                <Form onSubmit={(e) => e.preventDefault()} className="col-8">
                    <Form.Group as={Row} className="my-2 mx-2 ">
                        <InputGroup className="my-1">
                            ...
                            <FormControl placeholder="Назва спеціальності" onChange={(e) =>
                                handleChangeFilters("name", e.target.value)
                            }
                            />
                        </InputGroup>
                        <InputGroup className="my-1">
                            <SelectCathedra handleChangeFilters={handleChangeFilters}></SelectCathedra>
                        </InputGroup>
                    </Form.Group>
                </Form >
            </div>
