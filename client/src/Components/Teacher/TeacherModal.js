            ...
            <>
                <Modal size="lg" show={isopen} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>{item.id ? "Редагувати запис вчителя" : "Створити запис вчителя"}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form noValidate validated={this.state.validated}>
                            <Form.Group as={Row} className="my-2 mx-2">
                                ...
                                <Col>
                                    <Form.Control required placeholder="Ім'я" value={item.name} onChange={(e) => {
                            ...
                            <Form.Group as={Row} className="my-2 mx-2">
                                ...
                                <Col>
                                    <Form.Control required placeholder="Прізвище" value={item.surname} onChange={(e) => {
                            ...
                            <Form.Group as={Row} className="my-2 mx-2">
                                ...
                                <Col>
                                    <Form.Control required placeholder="По-батькові" value={item.patronymic} onChange={(e) => {
