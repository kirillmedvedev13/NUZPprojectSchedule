...
export const RUN_EACPP = {
  ...
  async resolve(parent, { id_cathedra }) {
    ...
    let fileName = path.resolve("./EvalutionAlgorithms/EvalutionAlgoritmCpp/build-EvalutionAlgorithmCpp-Desktop_Qt_6_4_0_MinGW_64_bit-Debug/debug/EvalutionAlgorithmCpp.exe");

    fs.writeFile("./EvalutionAlgorithms/EvalutionAlgoritmCpp/build-EvalutionAlgorithmCpp-Desktop_Qt_6_4_0_MinGW_64_bit-Debug/debug/data.json", jsonData, (err) => {
      if (err)
        console.log(err)
    })
