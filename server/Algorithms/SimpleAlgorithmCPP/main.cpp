    ...
    try
    {
        ...
        for (auto &cl : classes){
            ...
            for (size_t j = 0; j < info.size(); j++) {
                ...
                // Пройтись так же рекомендуемые аудитории, если они есть
                ...
                // Если рекомендуемого времени нету, то начать поиск свободной пары
                    ...
                    set_intersection(INTERSECTION_GROUPS.begin(), INTERSECTION_GROUPS.end(), INTERSECTION_TEACHERS.begin(), INTERSECTION_TEACHERS.end(), back_inserter(temp_intersection));
